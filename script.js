document.addEventListener('DOMContentLoaded', function() {
    ...
    const curriculum = [
        // Año 1
        {
            ...
            courses: [
                ...
                // ... (todos los demás cursos como en tu versión anterior)
                // Asegúrate de incluir todos los semestres del 1 al 10
            ]
        },
        // ... (todos los demás años y semestres)
    ];
    ...
    function openCourseModal(course, semesterData) {
        ...
        modalStatus.style.color = isCompleted ? 'var(--primary-dark)' : '#ff6b9d';
        
        // Configurar botón
        toggleCourseBtn.textContent = isCompleted ? 'Marcar como pendiente' : 'Marcar como aprobado';
        toggleCourseBtn.style.backgroundColor = isCompleted ? 'var(--primary-dark)' : 'var(--primary-color)';
    ...
    document.body.style.border = "3px solid var(--primary-color)";
});
